		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#successfactorsmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"successfactorsmasterdetail-display": {
								"semanticObject": "successfactorsmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=successfactors.masterdetail",
									"url": sap.ui.require.toUrl("successfactors/masterdetail")
								}
							}
						}
					}
