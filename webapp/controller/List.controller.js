sap.ui.define([
    ...
    return BaseController.extend("successfactors.masterdetail.controller.List", {
        ...
        onInit : function () {
            ...
            this.getOwnerComponent().getEventBus().subscribe("successfactors.masterdetail.controller.Detail", "refreshList", this.onRefresh, this);
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("userId", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "test.project1.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            var startDatestring = oItem.getBindingContext().getProperty("startDate")
            let startDate = new Date(startDatestring);
            let formattedStartDate = "datetime'" + startDate.toISOString().slice(0, 19).replace('T', 'T') + "'";
            var bReplace = !Device.system.phone;
            // set the layout property of FCL control to show two columns
            this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
            this.getRouter().navTo("object", {
                objectId1 : oItem.getBindingContext().getProperty("userId"),
                objectId2 : oItem.getBindingContext().getProperty("seqNumber"),
                objectId3 : formattedStartDate
            }, bReplace);
        },
